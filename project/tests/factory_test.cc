...
TEST_F(FactoryTest, DroneCreated) {
  ...
  TEST_F(FactoryTest, IndependentFactoryTests)
  {
    ...
    JsonHelper::AddStdFloatVectorToJsonObject(robot_obj, "position", position_to_add1);
    std::vector<float> direction_to_add1;
    JsonHelper::AddStdFloatVectorToJsonObject(robot_obj, "direction", direction_to_add1);
    ...
    JsonHelper::AddStdFloatVectorToJsonObject(customer_obj, "position", position_to_add2);
    std::vector<float> direction_to_add2;
    JsonHelper::AddStdFloatVectorToJsonObject(customer_obj, "direction", direction_to_add2);
    ...
    JsonHelper::AddStdFloatVectorToJsonObject(package_obj, "position", position_to_add3);
    std::vector<float> direction_to_add3;
    JsonHelper::AddStdFloatVectorToJsonObject(package_obj, "direction", direction_to_add3);
